...
mostrar_seleccion() {
  echo -e "\n > Configuracion seleccionada."; if [[ $NOSHOW == "n" ]]; then echo -en "¿quieres continuar?\n"; fi
...
green_color; echo " > Detectando servicios disponibles..."; default_color
...
# Limpiar ficheros de resultados (menos el JSON final)
Analysis-app/general/escoba.sh json
